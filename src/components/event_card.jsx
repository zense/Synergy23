        ...
        <div className="col">
          ...
          <div className="row">     
            <div class="accordion" id="accordionExample">
                ...
                <div className='accordion-content'>
                    <div className="event_text"><a href="https://iiitbac-my.sharepoint.com/:b:/g/personal/synergy_iiitb_ac_in/Ea5FWwrd4u1MvqB2XHkr6zcBnflgZbikeUXe8kRi8H_VbA?e=MRTaCf" target="_blank">Event Details    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-link" viewBox="0 0 16 16">
